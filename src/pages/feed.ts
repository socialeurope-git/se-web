...
import { authors, fixtureForSlug } from "../se/data";
...
export const GET: APIRoute = async () => {
	const { entries } = await getEmDashCollection("posts", { orderBy: { published_at: "desc" }, limit: 10 });
...
<channel>
	...
	<atom:link href="https://www.socialeurope.eu/feed" rel="self" type="application/rss+xml" />
